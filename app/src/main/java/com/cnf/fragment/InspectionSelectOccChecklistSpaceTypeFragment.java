...
import com.cnf.adapter.InspectionOccChecklistSpaceTypeAdapter;
import com.cnf.R;
...
public class InspectionSelectOccChecklistSpaceTypeFragment extends Fragment {
  ...
  class LoadOccChecklistSpaceTypeHeavy implements Runnable {
    ...
    @Override
    public void run() {
      occChecklistSpaceTypeHeavyList = occInspectionInfraService.getOccChecklistSpaceTypeHeavyListFromSQLite(inspectionDB, checklistId);
