...
public class AppConstants {
    ...
    public static final String TOAST_NEVER_BENN_ACTIVATED_MSG = "Never Been Activated, Login First!";
    public static final String TOAST_EMPTY_MUNICIPALITY_MSG = "Empty Municipality List!";
    ...
    public static final String ERROR_INSPECTION_TASK_FETCH_MSG = "Fetch Inspection Task Error!";

    public static final String ERROR_INSPECTION_TASK_FETCH_NULL_POINTER_MSG = "Fetch Null Inspection Task Error!";
    public static final String SUCCESS_INSPECTION_TASK_FETCH_MSG = "Success To Fetch Inspection Task!";
    ...
    public static final String INTENT_EXTRA_INSPECTION_ID_KEY = "INSPECTION_ID";
    public static final String INTENT_EXTRA_INSPECTION_CHECKLIST_ID_KEY = "CHECKLIST_ID";
